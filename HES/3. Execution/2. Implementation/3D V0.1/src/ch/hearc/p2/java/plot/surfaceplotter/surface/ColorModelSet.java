...
import ch.hearc.p2.java.plot.surfaceplotter.surface.SurfaceModel.PlotColor;
import ch.hearc.p2.java.plot.surfaceplotter.surface.SurfaceModel.PlotType;
...
public class ColorModelSet implements SurfaceColor
{
	...
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getBackgroundColor()
	 */
	public Color getBackgroundColor(){return lightColor;}
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getLineBoxColor()
	 */
	public Color getLineBoxColor() {return lineboxColor;}
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getBoxColor()
	 */
	public Color getBoxColor() {return boxColor;}
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getLineColor()
	 */
	public Color getLineColor(){return lineColor;}
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getTextColor()
	 */
	public Color getTextColor() {return lineColor;}
	
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getLineColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getPolygonColor(int, float)
	 */
	...
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getFirstPolygonColor(float)
	 */
	...
	/* (non-Javadoc)
	 * @see ch.hearc.p2.java.plot.surfaceplotter.SurfaceColor#getSecondPolygonColor(float)
	 */
