...
public class JPanelScale extends JPanel
	...
	public final static double[] scaleValues = { 0.001, 0.0013, 0.0016, 0.002, 0.0025, 0.0032, 0.004, 0.005, 0.0063, 0.008, 0.01, 0.013, 0.016, 0.02, 0.025, 0.032, 0.04, 0.05, 0.063, 0.08, 0.1, 0.13, 0.16, 0.2, 0.25, 0.32, 0.4, 0.5, 0.63, 0.8, 1.0, 1.3, 1.6, 2.0, 2.5, 3.2, 4.0, 5.0, 6.3, 8.0, 10.0,
			13.0, 16.0, 20.0, 25, 32, 40, 50, 63, 80, 100, 130, 160, 200, 250, 320, 400, 500, 630, 800, 1000 };
		...
		jSliderScale.addChangeListener(new ChangeListener()
			{
				...
				public void stateChanged(ChangeEvent e)
					...
					if (jSliderScale.getValue() >= 0)
						{
						newScaleFactor = Math.round(Math.pow(10, jSliderScale.getValue() / 10.0));
						}
					else
						{
						newScaleFactor = (float)Math.pow(10, jSliderScale.getValue() / 10.0);
						}
