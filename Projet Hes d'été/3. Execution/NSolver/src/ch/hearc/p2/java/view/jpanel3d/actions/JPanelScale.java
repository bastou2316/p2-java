...
public class JPanelScale extends JPanel {
	...
	public final static float[] scaleValues = { 0.001f, 0.0013f, 0.0016f,
			0.002f, 0.0025f, 0.0032f, 0.004f, 0.005f, 0.0063f, 0.008f, 0.01f,
			0.013f, 0.016f, 0.02f, 0.025f, 0.032f, 0.04f, 0.05f, 0.063f, 0.08f,
			0.1f, 0.13f, 0.16f, 0.2f, 0.25f, 0.32f, 0.4f, 0.5f, 0.63f, 0.8f,
			1.0f, 1.3f, 1.6f, 2.0f, 2.5f, 3.2f, 4.0f, 5.0f, 6.3f, 8.0f, 10f,
			13f, 16f, 20f, 25f, 32f, 40f, 50f, 63f, 80f, 100f, 130f, 160f,
			200f, 250f, 320f, 400f, 500f, 630f, 800f, 1000f };

	public JPanelScale(Font font, Color titleColor, float scaleFactor,
			final JPanel3D jPanel3d) {
