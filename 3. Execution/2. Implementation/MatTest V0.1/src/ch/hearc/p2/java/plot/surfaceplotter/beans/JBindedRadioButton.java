...
public class JBindedRadioButton extends JRadioButton {
	...
	/**
	 * @return
	 * @see ch.hearc.p2.java.plot.surfaceplotter.beans.BeanProperty#getPropertyName()
	 */
	...
	/**
	 * @param propertyName
	 * @see ch.hearc.p2.java.plot.surfaceplotter.beans.BeanProperty#setPropertyName(java.lang.String)
	 */
