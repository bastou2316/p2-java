...
import ch.hearc.p2.java.plot.surfaceplotter.beans.JBindedCheckBox;
import ch.hearc.p2.java.plot.surfaceplotter.beans.JBindedRadioButton;
import ch.hearc.p2.java.plot.surfaceplotter.beans.JScrollablePanel;
import ch.hearc.p2.java.plot.surfaceplotter.beans.ModelSource;
...
public class VerticalConfigurationPanel extends JScrollablePanel {
	...
	private void initComponents() {
		...
		ResourceBundle bundle = ResourceBundle.getBundle("ch.hearc.p2.java.plot.surfaceplotter.surface.VerticalConfigurationPanel");
		label1 = new JLabel();
